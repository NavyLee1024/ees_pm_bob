...
HD_PWD='C:/Users/Eureka/Desktop/EES_351/EES_351.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EES_351_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EES_351_wrapper.tcl -notrace
