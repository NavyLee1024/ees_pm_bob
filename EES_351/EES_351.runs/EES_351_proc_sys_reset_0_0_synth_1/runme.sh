...
HD_PWD='C:/Users/Eureka/Desktop/EES_351/EES_351.runs/EES_351_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EES_351_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EES_351_proc_sys_reset_0_0.tcl
