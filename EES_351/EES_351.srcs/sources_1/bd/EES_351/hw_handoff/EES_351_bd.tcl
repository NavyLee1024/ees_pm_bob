...
################################################################
# This is a generated script based on design: EES_351
#
...
proc create_root_design { parentCell } {
  ...
  set vid_hsync_0 [ create_bd_port -dir O -from 0 -to 0 vid_hsync_0 ]
  set vid_vsync_0 [ create_bd_port -dir O -from 0 -to 0 vid_vsync_0 ]
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {207.430} \
   CONFIG.CLKOUT1_PHASE_ERROR {155.997} \
   CONFIG.CLKOUT2_JITTER {181.548} \
   CONFIG.CLKOUT2_PHASE_ERROR {155.997} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {200} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {168.395} \
  ...
  # Create instance: video_0, and set properties
  set block_name video
  set block_cell_name video_0
  if { [catch {set video_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_3/Op1] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_2/dcm_locked]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports vid_hsync_0] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_ports vid_vsync_0] [get_bd_pins util_vector_logic_2/Res]
  connect_bd_net -net util_vector_logic_3_Res [get_bd_pins util_vector_logic_3/Res] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins video_0/video_de]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins util_vector_logic_2/Op1] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net video_0_vga_b [get_bd_ports vga_b] [get_bd_pins video_0/vga_b]
  connect_bd_net -net video_0_vga_g [get_bd_ports vga_g] [get_bd_pins video_0/vga_g]
  connect_bd_net -net video_0_vga_r [get_bd_ports vga_r] [get_bd_pins video_0/vga_r]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins video_0/vga_in_b] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins video_0/vga_in_r] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins video_0/vga_in_g] [get_bd_pins xlslice_2/Dout]
  ...
  set_property PFM_NAME {vendor:lib:EES_351:1.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {clk_out1 {id "3" is_default "true" proc_sys_reset "/proc_sys_reset_0"} clk_out2 {id "4" is_default "false" proc_sys_reset "/proc_sys_reset_1"} clk_out3 {id "5" is_default "false" proc_sys_reset "/proc_sys_reset_2"}} [get_bd_cells /clk_wiz_1]
  set_property PFM.AXI_PORT {M_AXI_GP1 {memport "M_AXI_GP" sptag "" memory ""} S_AXI_ACP {memport "S_AXI_ACP" sptag "" memory ""} S_AXI_HP1 {memport "S_AXI_HP" sptag "" memory ""} S_AXI_HP2 {memport "S_AXI_HP" sptag "" memory ""} S_AXI_HP3 {memport "S_AXI_HP" sptag "" memory ""}} [get_bd_cells /processing_system7_0]
  set_property PFM.IRQ {In2 {} In3 {} In4 {} In5 {} In6 {} In7 {} In8 {} In9 {} In10 {} In11 {} In12 {} In13 {} In14 {} In15 {}} [get_bd_cells /xlconcat_0]
